...
export const PROJECTS: Project[] = [
  ...
  },
  {
    slug: 'banya-39-215',
    title: 'Баня 3,9×2,15',
    description: 'Баня 3,9×2,15 из сухого профилированного кедрового мини бруса, парилка обшита осиновой вагонкой. Печь «Добропар 14», бак 50л из нержавейки, дымоход «Термофор» 0,8мм. Установка по противопожарным нормам. Электрика медным проводом в кабель канале. Обработка пропиткой, водоотведение. Мебель и камни в подарок.',
