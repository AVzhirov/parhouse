...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: 'Баня 5×2,4 на 3 отделения, высота потолка 2,10м, ширина парилки 2,25м. Выдвижной нижний полок, мойка из лиственницы. печь Добропар 14, бак 50л из нержавейки, дымоход «Термофор» 0,8мм. Электрика медным проводом в кабель канале, двойная пропитка. Мебель и камни в подарок.',
    image: '/projects/banya-brus-52-24/main.webp',
    year: 'n',
    price: 'от 350 000 ₽',
    gallery: [
